...
'.LCRun3::sec($cx, LCRun3::v($cx, $in, array('owner')), $in, false, function($cx, $in) {return '		<a class="'.htmlentities((string)LCRun3::v($cx, $in, array('className')), ENT_QUOTES, 'UTF-8').' collection-owner" href="'.htmlentities((string)LCRun3::v($cx, $in, array('link')), ENT_QUOTES, 'UTF-8').'">'.htmlentities((string)LCRun3::v($cx, $in, array('label')), ENT_QUOTES, 'UTF-8').'</a>
		<span>•</span>
